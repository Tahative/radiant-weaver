...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'selloraco.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = '98cab06e630e34218cf33a3b08cc0daa';
...
// Helper functions for checkout URL
