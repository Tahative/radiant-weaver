          ...
          {items.length === 0 ? (
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground mt-2">Browse our collection and add items to your cart</p>
              </div>
            </div>
          ) : (
            <>
                    ...
                    <div key={item.variantId} className="flex gap-4 p-2 border-b border-border">
                      ...
                      <div className="flex flex-col items-end gap-2 flex-shrink-0">
                        ...
                        <div className="flex items-center gap-1">
                          <Button variant="outline" size="icon" className="h-6 w-6" onClick={() => updateQuantity(item.variantId, item.quantity - 1)} disabled={isLoading}>
